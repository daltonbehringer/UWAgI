...
'''
Reads NetCDF files from the University of Wyoming King Air 2DP probe
...
class _reader(object):
    ...
    def __init__(self, filename):
        ...
        self.time = nc.variables['particle_time'] # time for each particle (seconds since beginning of day)
